...
mogrify -resize 1000x500 -compress none   $PARCELLE_ID"_"$PARCELLE_BBOX.red.ppm
potrace -t 5 -u 100 -s $PARCELLE_ID"_"$PARCELLE_BBOX.red.ppm -o $PARCELLE_ID.svg
potrace -t 5 -u 100 -b geojson $PARCELLE_ID"_"$PARCELLE_BBOX.red.ppm -o $PARCELLE_ID.geojson
